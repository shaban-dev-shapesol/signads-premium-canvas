...
const Hero = () => {
  ...
  const features = ["Premium Quality Materials", "Express 24hr Service Available", "Expert Installation Team", "Dedicated Account Manager"];

  // Set to null to use image fallback, or provide video URL
  const heroVideoUrl = null;
  return <section className="relative min-h-screen flex items-center overflow-hidden bg-primary pt-20">
      {/* Video or Image Background */}
      {heroVideoUrl ? <motion.div initial={{
      scale: 1.1
    }} animate={{
      scale: 1
    }} transition={{
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          delay: 0.6
            ...
            return <motion.div key={index} initial={{
              ...
              duration: 0.6,
              delay: 0.8 + index * 0.2
            }} className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-smooth">
