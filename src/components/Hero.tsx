...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      {/* Navigation Arrows - Hidden on mobile, Embla has built-in touch/swipe support */}
      <button
        onClick={scrollPrev}
        className="hidden sm:flex absolute left-4 md:left-6 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 items-center justify-center text-white hover:bg-white/20 transition-colors"
      ...
      <button
        onClick={scrollNext}
        className="hidden sm:flex absolute right-4 md:right-6 top-1/2 -translate-y-1/2 z-20 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 items-center justify-center text-white hover:bg-white/20 transition-colors"
