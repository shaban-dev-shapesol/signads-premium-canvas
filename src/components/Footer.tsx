      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-primary-foreground/70">
              <a href="tel:+447943432855" className="flex items-center gap-2 hover:text-accent transition-smooth">
                <Phone className="w-4 h-4 text-accent" />
                <span>0794 343 2855</span>
              </a>
              <a href="mailto:hello@signad.co.uk" className="flex items-center gap-2 hover:text-accent transition-smooth">
                <Mail className="w-4 h-4 text-accent" />
                <span>hello@signad.co.uk</span>
              </a>
        ...
        <div className="border-t border-primary-foreground/20 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-primary-foreground/70">
            <p>&copy; 2025 Signad. All rights reserved.</p>
